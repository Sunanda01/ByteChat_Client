...
import { Eye, EyeClosed, User, UserRoundPlusIcon } from "lucide-react";
...
export default function Register() {
  ...
  return (
    <div className="grid grid-cols-2 w-full h-[calc(100vh-4rem)] mt-16">
        ...
        <Card className="w-[450px] bg-gradient-to-r from-blue-300 to-green-300 ">
          ...
          <CardFooter className="flex justify-center flex-col gap-2">
            ...
            <div className="inline-flex justify-center gap-2 text-white">
              ...
              <Link to="/login" className="inline-flex items-center space-x-1 ">
      ...
      <div className="h-full flex justify-center items-center overflow-hidden border-l-1 border-gray-300">
